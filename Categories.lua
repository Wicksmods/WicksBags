...
-- ============================================================
-- Item class IDs (returned by GetItemInfoInstant as `classID`); the same
-- numbering on Forever and TBC:
...
local function autoGet(self, itemId, itemLink)
    ...
    local _, _, quality, _, _, _, _, _, _, _, _, _, _, bindType = ns.GetItemInfo(itemId)
